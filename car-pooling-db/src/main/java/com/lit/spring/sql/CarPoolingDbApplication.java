package com.lit.spring.sql;

import com.lit.spring.sql.entities.Car;
import com.lit.spring.sql.entities.Person;
import com.lit.spring.sql.entities.Trip;
...
public class CarPoolingDbApplication {

	public static void main(String[] args) {
		SpringApplication.run(CarPoolingDbApplication.class, args);
	}
